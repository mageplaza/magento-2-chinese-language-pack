...
2. [Install Chinese Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Chinese language pack](#3-how-to-active-hungarian-language-pack)
...
```
unzip master.zip app/i18n/Mageplaza/zh_hans_cn
```
